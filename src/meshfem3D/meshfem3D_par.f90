...
!---
  ...
  use constants, only: &
    ...
    REFERENCE_MODEL_VPREMOON,REFERENCE_MODEL_SEMUCB,REFERENCE_MODEL_PREM_A3D
  ...
  use constants, only: &
    ...
    ICRUST_SPIRAL,ICRUST_SH_MARS,ICRUST_BERKELEY
...
! main parameter module for specfem simulations
  ...
  use constants, only: myrank,CUSTOM_REAL,IMAIN,ISTANDARD_OUTPUT,IOUT,OUTPUT_FILES_BASE, &
    ...
    THREE_D_MODEL_S362ANI,THREE_D_MODEL_S362WMANI,THREE_D_MODEL_S362ANI_PREM,THREE_D_MODEL_S29EA, &
    THREE_D_MODEL_MANTLE_SH,THREE_D_MODEL_SPIRAL,THREE_D_MODEL_BERKELEY
